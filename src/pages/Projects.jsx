  ...
  const fallbackProjectsData = [
    {
      ...
      githubUrl: 'https://github.com/tayyabiziz-8/PvP-Chess',
      liveUrl: '',
      imageUrl: '',
    },
    {
      ...
      githubUrl: 'https://github.com/tayyabiziz-8/BudgetRep',
      liveUrl: '',
      imageUrl: '',
    },
    {
      ...
      githubUrl: 'https://github.com/tayyabiziz-8/dictionary-merge',
      liveUrl: '',
      imageUrl: '',
    },
    {
    ...
    },
    {
      ...
      technologies: ['Java', 'Android Development', 'API Integration'],
      githubUrl: 'https://github.com/tayyabiziz-8/WeatherApp',
    ...
    },
    {
      ...
      description: 'An AI-assisted interview coach and resume analyzer.',
      technologies: ['Python', 'Flask', 'HTML', 'AI-Integration'],
      githubUrl: 'https://github.com/tayyabiziz-8/interview-coach-app',
      liveUrl: '',
      imageUrl: '',
    },
    {
    ...
    },
    {
      ...
      technologies: ['SQL', 'Database Design', 'C++', 'Python'],
